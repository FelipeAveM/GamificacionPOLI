...
import co.edu.poli.gamification.poliplayapp.Admin.AdminFunctions;
import co.edu.poli.gamification.poliplayapp.Juegos.JuegoBuscarJavier;
import co.edu.poli.gamification.poliplayapp.Juegos.JuegoCalculadora;
import co.edu.poli.gamification.poliplayapp.Modelo.Usuario;
...
public class Login extends AppCompatActivity {
                            ...
                            if(!Login.user.getRole().equals("vacio")) {
                                if(!Login.user.getGroup().equals("vacio")) {
                                    if(!Login.user.getLevel().equals("0")) {
                                        if (!Login.user.getLevel().equals("FIN")) {
                                ...
                                startActivity(new Intent(getApplicationContext(), SeleccionarRol.class));
                            }
                        }
                        else{
    ...
    /*
    //Método para volver fullscreen la aplicación.
    @Override
