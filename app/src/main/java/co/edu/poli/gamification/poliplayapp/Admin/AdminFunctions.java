package co.edu.poli.gamification.poliplayapp.Admin;
...
import co.edu.poli.gamification.poliplayapp.Servicios.CheckForSDCard;
...
public class AdminFunctions extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        limpiar = (Button) findViewById(R.id.button6);
    }
    ...
    public void enableResetBut(View view){
        si.setVisibility(View.VISIBLE);
        no.setVisibility(View.VISIBLE);
        limpiar.setText("¿ESTÁ COMPLETAMENTE SEGURO QUE DESEA BORRAR LA BASE DE DATOS?");
    }
    public void disenableResetBut(View view){
        si.setVisibility(View.INVISIBLE);
        no.setVisibility(View.INVISIBLE);
        limpiar.setText("LIMPIAR BASE DE DATOS");
    }
    ...
    private class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                return "Descargando en : " + folder + fileName;
